...
import {RiCloseLine, RiDashboardLine, RiListCheck2, RiMenu3Fill, RiStethoscopeLine} from 'react-icons/ri'
import logo from '../assets/images/logo.png'
import sidebar_img from '../assets/images/undraw_diary_re_4jpc.svg'
...
function Sidebar() {
    ...
    const menu = [
        {name: 'Dashboard', icon: <RiDashboardLine className='mr-4' />, path: '/'},
        ...
        <aside>
            ...
            <div className='flex flex-col h-max'>
                ...
                <div className='flex flex-col gap-4 pt-10'>
                    <img src={sidebar_img} className="hidden lg:block w-fit" />
                </div>
            ...
            <button onClick={handleSidebar} className='block lg:hidden z-100 absolute bottom-4 right-4 bg-purple-600 p-2 text-white rounded-full text-2xl'>
